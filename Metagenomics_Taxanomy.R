...
phylum                  <- read.csv("Megan_phylum.csv", header = T,
                                    stringsAsFactors = FALSE)
colnames(phylum)        <- c("phylum",paste0("T1_",1:10),paste0("T2_",1:10),
                             paste0("T3_",1:10))
...
genus                   <- read.csv("Megan_genus.csv", header = T,
                                    stringsAsFactors = FALSE)
...
## PCoA plots ##
### phylum
phylum                  <- read.csv("Megan_phylum.csv", header = TRUE,
                                    stringsAsFactors = FALSE)
rownames(phylum)        <- phylum$X
